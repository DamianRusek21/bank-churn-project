...
# Simple NumPy usage: calculate mean balance using a NumPy array
mean_balance = np.mean(df["balance"].values)
print("Mean Balance (via NumPy): ", mean_balance)

# Simple Chi-Square Test: Check relationship between products and churn
